...
if (Config.WORKTYPE == 'private') {
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '▁ ▂ ▄ ▅ ▆ ▇ █ Godziila Bot by Punsith █ ▇ ▆ ▅ ▄ ▂ ▁'})
    ...
    await message.sendMessage(Buffer.from(ttinullimage.data), MessageType.image, { mimetype: Mimetype.jpg, caption: '▁ ▂ ▄ ▅ ▆ ▇ █ Godziila Bot by Punsith █ ▇ ▆ ▅ ▄ ▂ ▁' })
  ...
  var topText, bottomText;
    ...
    var topText, bottomText;
      ...
      var webimage = await axios.get(`https://api.zeks.xyz/api/gneon?apikey=7h7ZbRIwJTAXtuaBAbIBltOMYQ9&text=${topText}&text2=${bottomText}`, { responseType: 'arraybuffer' })
  ...
  var topText, bottomText;
   ...
   await message.client.sendMessage(message.jid,Buffer.from(webimage.data), MessageType.image, {mimetype: Mimetype.jpg, caption: '▁ ▂ ▄ ▅ ▆ ▇ █ Godziila Bot by Punsith █ ▇ ▆ ▅ ▄ ▂ ▁'})
    ...
    Asena.addCommand({pattern: 'hublogo ?(!*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {
    ...
    Asena.addCommand({pattern: 'tiklogo ?(!*)', fromMe: false, dontAddCommandList: true}, (async (message, match) => {

      if (match[1] === '') return await message.client.sendMessage(message.jid,NEED_WORD);

      var webimage = await axios.get(`https://api.zeks.xyz/api/gtext?apikey=7h7ZbRIwJTAXtuaBAbIBltOMYQ9&text1=${topText}&text2=${bottomText}`, { responseType: 'arraybuffer' })
